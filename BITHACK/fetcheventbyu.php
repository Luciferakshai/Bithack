...
$sql = "SELECT * FROM events WHERE event_type='$eventname'ORDER BY start_date DESC";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        "<div class='card'>
          <div class='card-content'>
            ...
            <p>Location: ". $venue ."</p>
            <a href='staffmark.html?event=". $name ."&type=". $eventname ."' class='btn'>Registered Students</a>
          </div>
        </div>";
    }
} else {
